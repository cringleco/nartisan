  ...
  describe(".nartisanrc", () => {
    it("uses .nartisanrc file", done => {
      ...
      gulp
        .src(Support.resolveSupportPath("tmp"))
        .pipe(helpers.clearDirectory())
        .pipe(helpers.copyFile(optionsPath, ".nartisanrc"))
        .pipe(helpers.overwriteFile(configContent, ".nartisanrc"))
    ...
    it("prefers CLI arguments over .nartisanrc file", done => {
